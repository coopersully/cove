...
const fromEmail = process.env.RESEND_FROM_EMAIL ?? "Hearth <onboarding@resend.dev>";
    ...
    html: `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 480px; margin: 0 auto; padding: 40px 20px;">
        ...
        <p style="color: #4a4a4a; line-height: 1.6;">
          We received a request to reset your Hearth account password. Click the button below to choose a new password.
        </p>
